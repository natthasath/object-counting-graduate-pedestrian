...
class ObjectCountingAPI:
    ...
    def count_objects_on_video(self, cap, targeted_classes=[], output_path="outputs/output.avi", show=False):
        ret, frame = cap.read()
    ...
    def count_objects_crossing_the_virtual_line(self, cap, line_begin, line_end, targeted_classes=[],
                                                output_path="outputs/output.avi", show=False):
...
if __name__ == '__main__':
    ...
    if cap.isOpened(): 
        ...
        print('width, height:', width, height)  # 1280.0 : 720.0
        print('fps:', fps)                      # 60.0
        print('frames count:', frame_count)     # -1.0
    ...
    # counter.count_objects_crossing_the_virtual_line(cap, line_begin=(950, 1080), line_end=(950, 0), show=True)
